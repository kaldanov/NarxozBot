...
public class DateKeyboard {
    ...
    public DateKeyboard(Calendar startDay) {
    ...
    public void setKeyboard(long keyboardId , long chatId){
    ...
    public Date getDateDate(String updateText) {
        return getCalendarDate(updateText)!= null ? getCalendarDate(updateText).getTime(): null;
    }
    ...
    private InlineKeyboardMarkup getInlineKeyboard(String[] namesButton) {
        ...
        if (keyboardId != 0 && chatId != 0){
            KeyboardService keyboardService = new KeyboardService();
            List<List<InlineKeyboardButton>> rowsForAdd = keyboardService.getRowsKeyboard(keyboardId, chatId);
